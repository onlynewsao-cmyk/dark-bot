...
const CATS = {
  ...
  perfil_extra: ['myvip','lid','perfilpic','avaliar','suporte','subdono','bug','atividade','rankativo','rankinativo','rankativos','checkativo','totalcmd','topcmd','caixa','rara','lendaria','roles','role.vou','role.nvou','role.confirmados','role.criar','role.alterar','role.excluir','mention','afk','voltei','statusbot','statusgp','zipbot','gitbot','likebot','infoff'],
  flood: ['flood'],
