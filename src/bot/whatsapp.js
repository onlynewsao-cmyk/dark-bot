  ...
  async start({ mode = 'qr', phoneNumber = null } = {}) {
    ...
    try {
      ...
      this.sock.ev.on('messages.upsert', async (m) => {
        try {
          // Listener (anti-delete + espião) - módulo pre-loaded
          await messageListener.onUpsert(this.sock, m, this.io);
