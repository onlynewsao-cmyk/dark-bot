...
async function handle(sock, msg) {
  ...
  const aliasMap = {
    ...
    yt: 'play', musica: 'play', music: 'play', ytmp3: 'play', ytmp4: 'video',
    ...
    menudl: 'menudownload', menugames: 'menujogos', menubotoes: 'menubtn', menubotao: 'menubtn',
    ...
    admins: 'admins', tagadmins: 'tagadmins', adm: 'admins',
    apagar: 'del', deletar: 'del', delete: 'del', d: 'del', mute: 'silenciar', unmute: 'silenciar', calar: 'silenciar',
    adicionar: 'add', addmembro: 'add', tempkick: 'tempban',
    ...
    bailar: 'dancar', dance: 'dancar', bite: 'morder', lick: 'beijar', pat: 'cafune', palmada: 'cafune', poke: 'empurrar',
  ...
  if (ctx.isGroup && groupConfig) {
    ...
    const adminControlCmds = ['bloquearcmd','desbloquearcmd','cmdsgrupo','blockcmd','unblockcmd','setnomebot','inatividade','inativos','warn','unwarn','warnings','resetwarn','regras','setregras','motivacao','tagadmins','admins','setdesc','setnomegrupo','del','add','tempban','silenciar'];
