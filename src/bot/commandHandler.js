...
async function handle(sock, msg) {
  ...
  const aliasMap = {
    ...
    s: 'sticker', fig: 'sticker', owner: 'dono', bot: 'info', portal18: 'cmdsocultos', ocultos: 'cmdsocultos', hidden: 'cmdsocultos',
    ...
    estilo: 'menustyle', menustilo: 'menustyle', aparencia: 'menustyle', aparência: 'menustyle', botoes: 'buttonmode', botões: 'buttonmode',
