...
async function handle(sock, msg) {
  ...
  const aliasMap = {
    ...
    menustickers: 'menustickers', menuia: 'menuia', menugrupo: 'menugrupo',
  ...
  if (ctx.isGroup && groupConfig) {
    ...
    const adminControlCmds = ['bloquearcmd','desbloquearcmd','cmdsgrupo','blockcmd','unblockcmd','setnomebot','inatividade','inativos','warn','unwarn','warnings','resetwarn','regras','setregras','motivacao','tagadmins','admins','setdesc','setnomegrupo'];
