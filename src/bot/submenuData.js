...
function categorize(cmd) {
  ...
  const OVERRIDES = {
    ...
    world:'search', mapa:'search', historia:'search', buscalivro:'search', buscar18:'search',
    ...
    gif:'stickers', gifreact:'stickers', ximg:'stickers', pin:'stickers', pack18:'stickers',
    packbusca:'stickers', packname:'stickers', takepack:'stickers', slypack:'stickers', sly:'stickers',
    ...
    manga:'search', mangacap:'search', 'mangá':'search', livros18:'search',
