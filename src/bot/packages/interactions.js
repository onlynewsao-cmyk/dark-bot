...
const GIF_QUERIES = {
  ...
  cafe:       'anime drinking coffee cozy',
  aura:       'anime aura power up',
  godadm:     'anime god mode aura power',
  meditar:    'anime meditation calm aura',
  treinar:    'anime training workout',
  estudar:    'anime studying books',
  cantar:     'anime singing microphone',
  cozinhar:   'anime cooking food',
  chorar:     'anime crying sad',
  rir:        'anime laughing happy',
  rezar:      'anime praying',
  trabalhar:  'anime working hard office',
  programar:  'anime coding computer',
  gamer:      'anime gaming',
  banho:      'anime bath relax',
};
