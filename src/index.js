...
async function bootstrap() {
  ...
  const isSecure = config.appUrl?.startsWith('https://') || config.nodeEnv === 'production';
  const sessionConfig = {
    secret: config.sessionSecret,
    resave: true, // Força o salvamento para evitar perda no Render
    saveUninitialized: false,
    proxy: true,
    name: 'darkbot.sid', // Nome personalizado do cookie
    cookie: {
